class Solution {
    public static int rob(int[] nums) {
        ...
        int intialMaximaFor_0th_index = maxTheft[ 0 ];
        int actualMaximaFor_0th_index = intialMaximaFor_0th_index;

        if(usedLastHouse[ 0 ]){

            actualMaximaFor_0th_index = intialMaximaFor_0th_index - Math.min( nums[0], nums[ len -1]   );
        }
        ...
        return Math.max(actualMaximaFor_0th_index, maxTheft[1]   );
