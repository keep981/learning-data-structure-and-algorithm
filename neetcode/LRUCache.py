class LRUCache_MySolution1(object):
    #This code is working but time limit exceeding as here both the get and put operation are big-oh(capacity) time complexity and the idea of using ageBit instead of datetime value come from the wikipedia Link mentioned in the descitption
